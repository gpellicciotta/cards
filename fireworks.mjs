...
import * as domutils from 'https://www.pellicciotta.com/hinolugi-support.js/js/domutils.mjs';
import {Vector, vectorFromPolar, vectorFromCartesian} from 'https://www.pellicciotta.com/hinolugi-support.js/js/vector.mjs';
